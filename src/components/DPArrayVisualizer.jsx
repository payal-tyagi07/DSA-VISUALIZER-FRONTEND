    ...
    <div className="flex gap-2 flex-wrap justify-center">
      {array.map((val, i) => (
        <div key={i} className="flex flex-col items-center">
          {/* Responsive box size: smaller on mobile, original on desktop */}
          <div className={`
            w-12 h-12 md:w-16 md:h-16
            flex items-center justify-center text-base md:text-lg font-mono rounded border
            ${highlight.current === i
              ? 'bg-yellow-800'
