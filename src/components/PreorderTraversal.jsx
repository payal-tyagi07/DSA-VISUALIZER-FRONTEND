...
const PreorderTraversal = () => {
  ...
  const generateSteps = (arr) => {
    ...
    preorder(root);
    steps.push({ root, visited: new Set(visitedSet), result, description: `Preorder traversal: ${result.join(', ')}` });
    return steps;
  };
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-[#0a0a0a] text-gray-200 rounded-2xl shadow-2xl font-mono border border-[#222222]">
      <div className="text-center mb-6">
        <h2 className="text-3xl font-bold text-[#569cd6] mb-2">Binary Tree Preorder Traversal</h2>
